...
@Component
class WatchedFolderProcessingStepListener extends StepExecutionListenerSupport {
    static final Logger log = LoggerFactory.getLogger(WatchedFolderProcessingStepListener.class);
